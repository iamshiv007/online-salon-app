...
import './team-css/AddTeamMember.css'
...
const AddTeamMember = () => {
  ...
  return (
    <div>
        <div className='d-flex justify-content-end p-1'><NavLink to="/teamMembers" style={{color:"black"}}><X size={45} strokeWidth={1.2}/></NavLink></div>
        <div className="body-wa">
            <div className='fs-1 text-center mb-2 fw-bolder'>Add team members</div>
            {/* Add manually */}
            <NavLink to='/addTeamMemberForm'>
